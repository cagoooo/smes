import{L as Ne,_ as re,C as se,r as Ke,E as Oe,n as ve,p as Fe,D,e as He,b as ye,g as qe,q as ze,u as Ue,t as je,h as We,j as Ge,k as Ve,l as u,o as Xe,m as H,s as Ye,G as Je}from"./index.esm2017-qAtVxLfM.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ie(e=!1){var t;return e?(t=self.grecaptcha)===null||t===void 0?void 0:t.enterprise:self.grecaptcha}function W(e){if(!l(e).activated)throw m.create("use-before-activation",{appName:e.name})}function ke(e){const t=Math.round(e/1e3),n=Math.floor(t/(3600*24)),o=Math.floor((t-n*3600*24)/3600),r=Math.floor((t-n*3600*24-o*3600)/60),s=t-n*3600*24-o*3600-r*60;let a="";return n&&(a+=R(n)+"d:"),o&&(a+=R(o)+"h:"),a+=R(r)+"m:"+R(s)+"s",a}function R(e){return e===0?"00":e>=10?e.toString():"0"+e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mt(e){if(ve()){let t;try{t=await lt(e)}catch(n){B.warn(`Failed to read token from IndexedDB. Error: ${n}`)}return t}}function K(e,t){return ve()?dt(e,t).catch(n=>{B.warn(`Failed to write token to IndexedDB. Error: ${n}`)}):Promise.resolve()}async function ft(){let e;try{e=await gt()}catch{}if(e)return e;{const t=Ue();return ut(t).catch(n=>B.warn(`Failed to persist debug token to IndexedDB. Error: ${n}`)),t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Et{constructor(t,n){this.app=t,this.heartbeatServiceProvider=n}_delete(){const{tokenObservers:t}=l(this.app);for(const n of t)Se(this.app,n.next);return Promise.resolve()}}function kt(e,t){return new Et(e,t)}function wt(e){return{getToken:t=>z(e,t),getLimitedUseToken:()=>yt(e),addTokenListener:t=>Be(e,"INTERNAL",t),removeTokenListener:t=>Se(e.app,t)}}const Ct="@firebase/app-check",Tt="0.8.8";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y{constructor(t){this._siteKey=t,this._throttleData=null}async getToken(){var t,n,o;Rt(this._throttleData);const r=await Bt(this._app).catch(a=>{throw m.create("recaptcha-error")});if(!(!((t=l(this._app).reCAPTCHAState)===null||t===void 0)&&t.succeeded))throw m.create("recaptcha-error");let s;try{s=await G(at(this._app,r),this._heartbeatServiceProvider)}catch(a){throw!((n=a.code)===null||n===void 0)&&n.includes("fetch-status-error")?(this._throttleData=_t(Number((o=a.customData)===null||o===void 0?void 0:o.httpStatus),this._throttleData),m.create("throttled",{time:ke(this._throttleData.allowRequestsAfter-Date.now()),httpStatus:this._throttleData.httpStatus})):a}return this._throttleData=null,s}initialize(t){this._app=t,this._heartbeatServiceProvider=ye(t,"heartbeat"),It(t,this._siteKey).catch(()=>{})}isEqual(t){return t instanceof Y?this._siteKey===t._siteKey:!1}}function _t(e,t){if(e===404||e===403)return{backoffCount:1,allowRequestsAfter:Date.now()+nt,httpStatus:e};{const n=t?t.backoffCount:0,o=je(n,1e3,2);return{backoffCount:n+1,allowRequestsAfter:Date.now()+o,httpStatus:e}}}function Rt(e){if(e&&Date.now()-e.allowRequestsAfter<=0)throw m.create("throttled",{time:ke(e.allowRequestsAfter-Date.now()),httpStatus:e.httpStatus})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
